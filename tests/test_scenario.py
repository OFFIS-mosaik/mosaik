...
from mosaik.tiered_time import TieredDuration
...
def test_world_connect(world: World):
    ...
    assert sim_1.input_delays[sim_0] == TieredDuration(0)
...
def test_world_connect_any_inputs(world: World):
    ...
    assert sim_b.input_delays[sim_a] == TieredDuration(0)
    assert to_dict(world.entity_graph) == {
...
def test_model_factory_hierarchical_entities_illegal_type(
    world: World, mf: ModelFactory
):
    ret = [
        {
            "eid": "a",
