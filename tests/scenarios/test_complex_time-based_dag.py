...
def create_scenario(world: World):
    simulator_a = world.start('A', sim_id="A", step_size=1)
    simulator_b = world.start('B', sim_id="B", step_size=2)
    simulator_c = world.start('C', sim_id="C", step_size=1)
    simulator_d = world.start('D', sim_id="D", step_size=4)
    simulator_e = world.start('E', sim_id="E", step_size=3)
