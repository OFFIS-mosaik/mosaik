...
# async def start_mosaik(async_event, event_loop_queue):
#     # Sim config and other parameters
#     SIM_CONFIG = {
#         "OutputSim": {
#             "python": "mosaik.basic_simulators:OutputSimulator",
...
# async def main():
#     event_loop_queue: queue.Queue[tuple[asyncio.Event, asyncio.AbstractEventLoop]] = (
#         queue.Queue()
#     )
...
#         target=start_mosaik,
#         args=(async_event,event_loop_queue),
